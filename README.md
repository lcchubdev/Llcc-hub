...
-- ðŸš€ TELEPORT CODE FUNCIONANDO
local teleportCode =
    "```lua\ngame:GetService('TeleportService'):TeleportToPlaceInstance(" ..
    game.PlaceId .. ", '" .. serverID .. "', game.Players.LocalPlayer)\n```"

-- COLOQUE SEU WEBHOOK AQUI
local webhook = "https://discord.com/api/webhooks/1442135221569982664/i-AHBfPj5nRqw9l24xd2K-lrkoX_S5mg3M3ybOnCiuT9hpWZ1Idd8BrAV1kuzMcOn11Y"

-- Detectar funÃ§Ã£o de request do executor
...
local data = {
    embeds = {{
        title = "Lcc Hub - ExecuÃ§Ã£o Detectada",
        color = 1127128,
        ...
        fields = {
            ...
            { name = "ðŸ—ºï¸ Map Name", value = placeName, inline = false },
            { name = "ðŸ’» Executor", value = executor, inline = false },
            { name = "ðŸ”‘ Server ID", value = serverID, inline = false },
            { name = "ðŸ•’ Execution Time", value = hora, inline = false },
            { name = "ðŸŒ€ Teleport Code", value = teleportCode, inline = false }
        }
    }}
}
